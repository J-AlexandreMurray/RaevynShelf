...
export default function About() {
  return <main className="page legal">
    ...
    <p>The RaevynTide Library app is intended to remain free to use indefinitely. If you enjoy it, you can optionally support its independent development through Ko-fi.</p>
    {kofiUrl ? <a className="primary" href={kofiUrl} target="_blank" rel="noreferrer">☕ Support development</a>}
  </main>;
}
